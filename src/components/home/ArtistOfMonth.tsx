      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
        <div className="md:sticky md:top-24 md:self-start" data-cursor="art">
          <div className="overflow-hidden">
            <img src={featuredArtist.portrait} alt={featuredArtist.name} loading="lazy" className="w-full aspect-[3/4] object-cover" />
          </div>
          <h3 className="editorial-heading text-foreground text-3xl md:text-5xl mt-6">{featuredArtist.name}</h3>
        </div>
