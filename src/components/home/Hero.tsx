      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-12">
        <div>
          <div ref={line1Ref} className="overflow-hidden">
            <h1
              className="editorial-heading text-primary-foreground"
          ...
          <div ref={line2Ref} className="overflow-hidden -mt-2 md:-mt-6">
            <h1
              className="editorial-heading text-primary-foreground italic"
              style={{ fontSize: "clamp(3.5rem, 12vw, 11rem)" }}
            >
              Central
            </h1>
          ...
          <p
            ref={subtitleRef}
            className="micro-text text-primary-foreground/70 mt-6 md:mt-8 max-w-md opacity-0"
          >
